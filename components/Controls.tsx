      ...
      <>
        ...
        <div className="bg-zinc-800/50 p-4 rounded-xl border border-zinc-700/50">
            ...
            <input 
                ...
                className="flex-1 bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 text-sm focus:outline-hidden focus:ring-2 focus:ring-blue-500/50 placeholder:text-zinc-600"
            />
            <button 
                type="submit" 
                disabled={isGenerating || !prompt}
                className="bg-linear-to-br from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed text-white p-2 rounded-lg transition-all"
            >
