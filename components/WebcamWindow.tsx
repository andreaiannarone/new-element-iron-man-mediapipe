...
const WebcamWindow: React.FC = () => {
  ...
  return (
    <div 
      className="fixed z-40 w-56 rounded-xl overflow-hidden shadow-2xl border border-zinc-700/50 bg-black/80 backdrop-blur-sm group"
      style={{
    ...
    >
      <div className="relative aspect-video bg-zinc-900">
        ...
        <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity bg-black/50 p-1 rounded-sm">
